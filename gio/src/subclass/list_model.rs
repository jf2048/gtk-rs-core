...
impl<T: ListModelImpl> ListModelImplExt for T {
    fn parent_item_type(&self, list_model: &Self::Type) -> glib::Type {
        unsafe {
            ...
            let ret = func(list_model.unsafe_cast_ref::<ListModel<Object>>().to_glib_none().0);
            from_glib(ret)
        }
    }
    ...
    fn parent_n_items(&self, list_model: &Self::Type) -> u32 {
        unsafe {
            ...
            func(list_model.unsafe_cast_ref::<ListModel<Object>>().to_glib_none().0)
        }
    }
    ...
    fn parent_item(&self, list_model: &Self::Type, position: u32) -> Option<Object> {
        unsafe {
            ...
            let ret = func(
                list_model.unsafe_cast_ref::<ListModel<Object>>().to_glib_none().0,
                position,
            );
            from_glib_full(ret)
        }

...
unsafe extern "C" fn async_initable_init_async<T: AsyncInitableImpl>(
    ...
    glib::MainContext::default().spawn_local(async move {
        let res = imp
            .init_future(initable.unsafe_cast_ref(), from_glib(io_priority))
            .await;
...
mod tests {
    ...
    pub mod ffi {
        ...
        #[no_mangle]
        pub unsafe extern "C" fn async_initable_test_type_get_type() -> glib::ffi::GType {
            imp::AsyncInitableTestType::type_().into_glib()
        }
    ...
    #[test]
    fn test_async_initable_with_initable_with_values() {
        glib::MainContext::new().block_on(async {
